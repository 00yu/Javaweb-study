		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="${pageContext.request.contextPath}/products/hao/big01.jpg" width="305" height="604" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:300px;padding:0px;">
						<img src="${pageContext.request.contextPath}/products/hao/middle01.jpg" width="750px" height="300px" style="display: inline-block;">
					</div>
					
				<c:forEach items="${hList }" var="p">
					<div class="col-md-2" style="text-align:center;height:300px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/product?method=getById&pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${p.pimage}" width="220" height="220" style="display: inline-block;">
						</a>
